...
function afficherAgent($agent){
  ...
  <p><form action="garage.php" method="post">
  <button name="client" type="submit" ><img src="vue/style/img/sample.png" width="100" height="100"/><br/>Clients et Prise de RDV</button>
  <button name="paiements" type="submit" ><img src="vue/style/img/credit-card.png   " width="100" height="100"/><br/>Paiements</button>';
    $contenuAffichage.="</form>";
    require_once('gabarit.php');
}
